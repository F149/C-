...
//  сравнивающей два диапазона элементов (в нашем случае — два набора
//  символов) с помощью данного компаратора. В компараторе для функции
//  lexicographical_compare мы используем функцию tolower, возвращающую
//  символ, приведённый к нижнему регистру.
//
///////////////////////////////////////////////////////////////////////////////
#include <iostream>
#include <string>
