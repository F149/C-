///////////////////////////////////////////////////////////////////////////////
//
//  Новые уточнения в целом упрощают задачу по сравнению с предыдущей версией:
//  функция BuildFullName больше не нужна, потому что имя и фамилия всегда
//  известны — для получения полного имени достаточно объединить их через пробел.
//
//  В связи с добавлением требований про год рождения потребуются следующие
//  изменения:
//     1.Напишем конструктор, сохраняющий в поле класса год рождения,
//       а имя и фамилию — в соответствующие словари.
