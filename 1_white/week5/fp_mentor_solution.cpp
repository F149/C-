...
//  удаление конкретного события, используем словарь множеств — map<Date, set>,
//  для каждой даты хранящий множество соответствующих событий.
//
//  Кроме того, важно было аккуратно организовать обработку ошибок — тут
//  очень помогает механизм исключений. Обратите внимание, например, на
//  проверку корректности дня и месяца в дате: она вынесена в конструктор
//  даты, что позволяет не заботиться об этом во всех остальных функциях,
//  работающих с датами.
//
////////////////////////////////////////////////////////////////////////////////
#include <cstdint>
